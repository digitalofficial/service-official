        ...
        <div className="flex items-start justify-between mb-10">
          <div className="flex items-start gap-4">
            {organization?.logo_url ? (
              ...
              <div className="w-14 h-14 rounded-xl flex items-center justify-center text-white text-xl font-bold" style={{ backgroundColor: primaryColor }}>
                {organization?.name?.[0] ?? 'S'}
              </div>
            )}
            <div>
              <h1 className="text-xl font-bold" style={{ color: secondaryColor }}>{organization?.name}</h1>
          ...
          <div className="text-right">
            <h2 className="text-3xl font-bold tracking-tight" style={{ color: primaryColor }}>ESTIMATE</h2>
            <p className="text-sm text-gray-500 mt-1">{estimate.estimate_number}</p>
          </div>
        </div>
